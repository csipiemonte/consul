class Admin::Poll::OfficerAssignmentsController < Admin::BaseController
  ...
  # creazione di una nuova assegnazione 'presidente di seggio - urna - data'
  def create
    ...
    @officer_assignment.final = true if @booth_assignment && @officer_assignment.date && @officer_assignment.date > @booth_assignment.poll.ends_at.to_date
