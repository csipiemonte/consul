...
class ProposalsController < ApplicationController
  ...
  private
    ...
    # versione custom di 'load_featured', per non avere il box giallo con le proposte in evidenza.
    def load_featured
      ...
      @featured_proposals = Proposal.not_archived.sort_by_confidence_score.limit(0)
